...
namespace UnityEngine.XR.Interaction.Toolkit.Locomotion.Turning
{
    ...
    public class SnapBullcrapTurnProvider : LocomotionProvider
    {
        ...
        protected void Update()
        {
			...
			// With the one following line
			    transform.rotation *= Quaternion.AngleAxis(amount, Vector3.forward);
			//which WILL cause problems later down the line :) 
